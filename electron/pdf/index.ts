 ...
 *
 * The legacy same-page replacement path (capturePdf / typesetPdf) was removed;
 * placeholders (freeze/restore) and the glossary stay because the live pipeline
 * uses them during translation.
 */
